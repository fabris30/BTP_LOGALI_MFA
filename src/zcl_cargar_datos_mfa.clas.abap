CLASS zcl_cargar_datos_mfa DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_cargar_datos_mfa IMPLEMENTATION.
method if_oo_adt_classrun~main.

    data: lt_acc_categ type table of ztb_acc_categ_m,
          lt_catego    type table of ztb_catego_mfa,
          lt_clientes  type table of ztb_clientes_mfa,
          lt_clnts_lib type table of ztb_clnts_lib_m,
          lt_libros    type table of ztb_libros_mfa.
...
******** ztb_acc_categ_m ********
    ...
    delete from ztb_acc_categ_m.
    insert ztb_acc_categ_m from table @lt_acc_categ.
...
******** ztb_catego_mfa ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_catego_mfa.
    insert ztb_catego_mfa from table @lt_catego.
...
******** ztb_clientes_mfa ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_clientes_mfa.
    insert ztb_clientes_mfa from table @lt_clientes.
...
******** ztb_clnts_lib_m
    ...
    "Delete possible entries; insert new entries
    delete from ztb_clnts_lib_m.
    insert ztb_clnts_lib_m from table @lt_clnts_lib.
...
******** ztb_libros_mfa ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ztb_libros_mfa.
    insert ztb_libros_mfa from table @lt_libros.
